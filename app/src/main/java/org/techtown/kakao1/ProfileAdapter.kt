...
class ProfileAdapter(val profileList : ArrayList<Profiles>) : RecyclerView.Adapter<ProfileAdapter.CustomViewHolder>(){
    ...
    override fun onBindViewHolder(holder: ProfileAdapter.CustomViewHolder, position: Int) {
        ...
        holder.profile.setImageResource(profileList[position].profile)
        ...
        holder.switch.setOnCheckedChangeListener { buttonView, isChecked ->
             profileList[position].checked = isChecked
        }
        holder.switch.isChecked = profileList[position].checked
    }
    ...
    class CustomViewHolder(ItemView: View) : RecyclerView.ViewHolder(ItemView){
        ...
        val switch: Switch = itemView.findViewById<Switch>(R.id.switch0)
